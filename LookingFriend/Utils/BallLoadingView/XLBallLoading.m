...
-(void)initUI{
    ...
    _ballContainer.frame = CGRectMake(0, 0, 60, 60);
    _ballContainer.center = CGPointMake([UIScreen mainScreen].bounds.size.width * 0.5, [UIScreen mainScreen].bounds.size.height * 0.5 - 60);
...
+(void)showInView:(UIView *)view{
    ...
    XLBallLoading *loading = [[XLBallLoading alloc] initWithFrame:[UIScreen mainScreen].bounds];
