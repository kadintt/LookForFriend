...
//    indexLabel.layer.cornerRadius = indexLabel.bounds.size.height * 0.5;
    ...
    [saveButton setImage:[UIImage imageNamed:@"save_image_btn"] forState:UIControlStateNormal];
...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo;
{
    ...
    label.bounds = CGRectMake(0, 0, 230, 50);
...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, [UIScreen mainScreen].bounds.size.height - 35);
    _saveButton.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 42, [UIScreen mainScreen].bounds.size.height - 47, 26, 26);
}
